...
public class RadioPlayType extends BasicType {
    ...
    public static final GenricObjectType SHOW_TITLE = new GenricObjectType("string.title.show", 0.9f, 0.0f, false, false, false, new PersonNameSimilarity());
    ...
    public static final GenricObjectType PERSON_INVOLVED = new GenricObjectType("string.person_name.involved", 1.0f, 0.0f, false, false, false, new PersonNameSimilarity());
