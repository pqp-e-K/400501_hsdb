...
public class RadioPlayType extends BasicType {
    public static final GenricObjectType TITLE = new GenricObjectType("string.title", 0.9f, 0.0f, true, true, true, new FuzzyStringVariantSimilarity(new InstitutionNameSimilarity(new ScaledLevensteinWithPartTest(), 2.0d, 0.5d, true, 0.0f), FuzzyStringVariantSimilarity.OutputSetting.MAX,true));
    public static final GenricObjectType SHOW_TITLE = new GenricObjectType("string.title.show", 0.9f, 0.0f, false, false, false, new FuzzyStringVariantSimilarity(new InstitutionNameSimilarity(new ScaledLevensteinWithPartTest(), 2.0d, 0.5d, true, 0.0f), FuzzyStringVariantSimilarity.OutputSetting.MAX,true));
    public static final GenricObjectType LONG_TITLE = new GenricObjectType("string.title.long", 1.0f, 0.0f, false, false, false, new FuzzyStringVariantSimilarity(new InstitutionNameSimilarity(new ScaledLevensteinWithPartTest(), 2.0d, 0.5d, true, 0.0f), FuzzyStringVariantSimilarity.OutputSetting.MAX,true));
