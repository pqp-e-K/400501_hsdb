...
public class RadioPlayType extends BasicType {
    public static final GenricObjectType TITLE = new GenricObjectType("string.title", 1.0f, 0.0f, false, false, false, new EqualSimilarity());
    ...
    public static final GenricObjectType DURATION = new GenricObjectType("float.duration", 1.0f, 0.0f, false, false, false, new EqualSimilarity());
    ...
    public static final GenricObjectType PUBLISHER = new GenricObjectType("string.publisher", 1.0f, 0.0f, false, false, false, new EqualSimilarity());
    ...
    public static final GenricObjectType PERSON_INVOLVED = new GenricObjectType("string.person_name.involved", 1.0f, 0.0f, false, false, false, new EqualSimilarity());
